...
// Module semiceu/style
// Inserts a link to the appropriate SEMICEU style for the specification's maturity level.
// CONFIGURATION
...
export const name = "semiceu/style";
...
function createResourceHints() {
  ...
  const opts = [
    ...
    },
    {
      ...
      href: "https://semiceu.github.io/respec-style/logos/SEMICEU.png",
      as: "image",
    },
  ];
...
//  const finalStyleURL = `https://www.w3.org/StyleSheets/TR/${finalVersionPath}${styleFile}`;
  const finalStyleURL = `https://semiceu.github.io/respec-style/${styleFile}`;
